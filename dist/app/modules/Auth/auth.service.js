...
const loginUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const checkPassword = yield user_model_1.User.isPasswordMatched(payload === null || payload === void 0 ? void 0 : payload.password, user === null || user === void 0 ? void 0 : user.password);
    if (!checkPassword) {
